...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        charlie.setBsnNumber("456789123");
        charlie.setPhoneNumber("+3456789123");
        ...
        aliceChecking.setAbsoluteTransferLimit(new BigDecimal("100.00"));
        aliceChecking.setDailyTransferAmount(new BigDecimal("0.00"));
        ...
        aliceSavings.setAbsoluteTransferLimit(new BigDecimal("500.00"));
        ...
        charlieChecking.setIBAN("NL11122233344455566677");
        ...
        charlieChecking.setAbsoluteTransferLimit(new BigDecimal("200.00"));
        ...
        charlieSavings.setIBAN("NL77766655544433322211");
        charlieSavings.setCustomer(charlie);
        charlieSavings.setAccountType(AccountType.SAVINGS);
        charlieSavings.setBalance(new BigDecimal("10000.00"));
        charlieSavings.setAbsoluteTransferLimit(new BigDecimal("1000.00"));
        ...
        txn1.setTimestamp(LocalDateTime.now().minusDays(5));
        ...
        txn2.setTimestamp(LocalDateTime.now().minusDays(3));
        txn2.setInitiator(alice);
        txn2.setTransactionType(TransactionType.TRANSFER);

        Transaction txn3 = new Transaction();
        txn3.setFromAccount(null);
        txn3.setToAccount(charlieChecking);
        txn3.setAmount(new BigDecimal("2000.00"));
        txn3.setTimestamp(LocalDateTime.now().minusDays(4));
        txn3.setInitiator(charlie);
        txn3.setTransactionType(TransactionType.DEPOSIT);

        Transaction txn4 = new Transaction();
        txn4.setFromAccount(charlieChecking);
        txn4.setToAccount(charlieSavings);
        txn4.setAmount(new BigDecimal("1000.00"));
        txn4.setTimestamp(LocalDateTime.now().minusDays(2));
        txn4.setInitiator(charlie);
        txn4.setTransactionType(TransactionType.TRANSFER);

        Transaction txn5 = new Transaction();
        txn5.setFromAccount(charlieChecking);
        txn5.setToAccount(aliceChecking);
        txn5.setAmount(new BigDecimal("250.00"));
        txn5.setTimestamp(LocalDateTime.now().minusDays(1));
        txn5.setInitiator(bob);  // Employee initiated
        txn5.setTransactionType(TransactionType.TRANSFER);
